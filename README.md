...
1) Create a GitHub Repository with the name `Jenkins-Realworld-CICD-Project` and push the code in this branch(main) to 
    ...
    - Download the code in in this repository `"Main branch"`: https://github.com/lwersiy/realworld-cicd-pipeline-project.git
...
3) Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/lwersiy/realworld-cicd-pipeline-project/blob/maven-sonarqube-nexus-jenkins-install/jenkins-install.sh
    - Launch Instance
...
4) SonarQube
    ...
    - User data (Copy the following user data): https://github.com/lwersiy/realworld-cicd-pipeline-project/blob/maven-sonarqube-nexus-jenkins-install/sonarqube-install.sh
    - Launch Instance
...
5) Nexus
    ...
    - User data (Copy the following user data): https://github.com/lwersiy/realworld-cicd-pipeline-project/blob/maven-sonarqube-nexus-jenkins-install/nexus-install.sh
    - Launch Instance
